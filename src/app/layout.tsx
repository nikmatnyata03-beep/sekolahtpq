...
export const metadata: Metadata = {
  ...
  title: "SIMADJI â TPQ Darul Jinan | Sistem Informasi Manajemen Terpadu",
  description:
  ...
  openGraph: {
    title: "TPQ Darul Jinan â Taman Pendidikan Al-Qur'an",
    description:
    ...
    siteName: "SIMADJI â TPQ Darul Jinan",
    locale: "id_ID",
    type: "website",

...
export function AnnouncementsSection() {
  ...
  return (
    <section id="pengumuman" aria-labelledby="pengumuman-heading" className="scroll-mt-20 bg-stone-50 py-16">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <h2
            ...
            className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-3xl font-bold tracking-tight text-stone-800"
          >
            Pengumuman Terbaru
              ...
              {featured.map((item) => {
                ...
                return (
                  <article
                    ...
                    className={
                      'group flex cursor-pointer flex-col rounded-2xl border border-stone-200 bg-white p-5 shadow-sm outline-none transition-all hover:-translate-y-0.5 hover:shadow-md focus-visible:ring-2 focus-visible:ring-emerald-600' +

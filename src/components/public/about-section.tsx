...
// Tentang Kami — visi & misi, sejarah singkat (timeline), struktur organisasi,
// dan keunggulan TPQ Darul Jinan. Konten statis sesuai profil lembaga.
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mx-auto mb-12 max-w-2xl text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-stone-800">
            Membina Generasi Qur&apos;ani yang Berakhlak Mulia
          </h2>
          <p className="mt-3 text-muted-foreground">
            TPQ Darul Jinan adalah lembaga pendidikan Al-Qur&apos;an untuk anak dan remaja di Cibubur,
            Jakarta Timur — berkhidmat menanamkan cinta Al-Qur&apos;an sejak dini.
          </p>
        </div>

        {/* Visi & Misi */}
        <div className="grid gap-6 md:grid-cols-2">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-800 to-emerald-950 p-6 text-white shadow-md md:p-8">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-lg font-medium leading-relaxed text-emerald-50">
                &ldquo;Menjadi TPQ yang unggul dalam melahirkan generasi penghafal dan pencinta
                Al-Qur&apos;an yang berakhlak mulia, beradab, dan bermanfaat bagi umat.&rdquo;
              </p>
        ...
        <div className="mt-16">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {KEUNGGULAN.map((item) => (
              <div
                key={item.title}
                className="group rounded-2xl border border-stone-200 bg-white p-6 text-center shadow-sm transition-all hover:-translate-y-0.5 hover:border-emerald-200 hover:shadow-lg"
              >
